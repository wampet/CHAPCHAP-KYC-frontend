...
class FrontIndividual_National_id extends StatefulWidget {
  const FrontIndividual_National_id({Key? key}) : super(key: key);

  @override
  State<FrontIndividual_National_id> createState() => _FrontIndividual_National_idState();
}

class _FrontIndividual_National_idState extends  State<FrontIndividual_National_id> {
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Container(
                        ...
                        child: InkWell(
                          onTap: () {
                            Navigator.pushNamed(context,'/BackindividualNationalId' );
